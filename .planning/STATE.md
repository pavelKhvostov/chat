...
status: unknown
last_updated: "2026-04-15T18:52:51.822Z"
progress:
  total_phases: 10
  completed_phases: 1
  total_plans: 4
...
| Phase | Status |
|-------|--------|
| 1 — БД и схема | ⬜ Pending |
| 2 — Аутентификация | ⬜ Pending |
| 3 — Layout + Sidebar | ⬜ Pending |
| 4 — Чат + Realtime | ⬜ Pending |
| 5 — Вложения | ⬜ Pending |
| 6 — DM + Presence | ⬜ Pending |
| 7 — Поиск + закреп | ⬜ Pending |
| 8 — Админ-панель | ⬜ Pending |
| 9 — PWA | ⬜ Pending |
| 10 — QA | ⬜ Pending |
