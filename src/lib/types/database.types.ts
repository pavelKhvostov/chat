  ...
  public: {
    Tables: {
      direct_chat_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "direct_chat_members_chat_id_fkey"
            columns: ["chat_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "direct_chat_members_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      folder_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "folder_items_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      is_direct_chat_member: { Args: { p_chat_id: string }; Returns: boolean }
